...
const Survey: React.FC<SurveyProps> = ({ id, user_question, isSenior = false }) => {
  ...
  return (
    <div>
      <div className={`flex flex-row w-full max-w-[330px] md:max-w-none md:w-[350px] items-center ${isSenior ? 'bg-[#FFEFEF]' : 'bg-gray-100'} font-5medium text-[#686D76] text-base md:text-lg mt-[8px] rounded-[20px] px-[20px] py-[10px]`}>
        <p>
      ...
      {thumbDown && !flag && (
        <div className={`flex flex-col w-full max-w-[330px] md:max-w-none md:w-[350px] ${isSenior ? 'bg-[#FFEFEF]' : 'bg-gray-100'} font-4regular text-[#686D76] text-base md:text-lg mt-[8px] rounded-[20px] px-[20px] py-[10px]`}>
